...
const account1 = {
  ...
  movements: [200, 450, -10000, -400, 3000, -650, -130, 70, 1300],
  interestRate: 1.2, // %
  pin: 1111,
...
// accumulator -> similar to a snowball
...
// you can select how many layers deep you wanna go
...
console.log(Number.parseInt('2.5rem')); // stops at the decimal
